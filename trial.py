...
Commented out IPython magic to ensure Python compatibility.
 ...
 def load_asr_pipeline():
     # ✅ Add chunk_length_s to avoid long-audio (>30s) crash
     return pipeline(
 ...
 [data-testid="stAppViewContainer"] {
     background-image: url("https://images.unsplash.com/photo-1519677100203-a0e668c92439?auto=format&fit=crop&w=1920&q=80"); /* 🎧 headphone image */
 ...
 st.title("EchoVerse 🎶")
 st.write("Transform text into expressive audiobooks — Neutral, Suspenseful, Inspiring — Now in English, Tamil & Hindi")
 ...
 if st.button("✨ Generate Audiobook"):
     if input_text.strip():
         ...
         st.download_button("⬇️ Download MP3", data=bio, file_name=fname, mime="audio/mp3")
...
# ---- Past Narrations ----
 st.markdown("---")
 st.header("📂 Past Narrations (this session)")
 ...
 st.markdown("---")
 st.header("🎤 Speech to Text (English / Tamil / Hindi)")
